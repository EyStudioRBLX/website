...
const services = [
  { emoji: '🎨', title: 'Game Design',        desc: 'Von der Idee bis zum Spielkonzept. Gameplay-Loops, die süchtig machen und Spieler stundenlang fesseln.',   color: '#8b5cf6' },
  { emoji: '💻', title: 'Lua Scripting',      desc: 'Sauberer, performanter Luau-Code. Moderne Server-Client-Architektur für maximale Stabilität.',                color: '#22d3ee' },
  { emoji: '🏗️', title: '3D Building',        desc: 'Atemberaubende Roblox-Maps mit detailreichem Worldbuilding. Jede Map erzählt ihre eigene Geschichte.',      color: '#e879f9' },
  { emoji: '📱', title: 'UI/UX Design',       desc: 'Intuitive Interfaces, die den Spielfluss stärken. Pixel-perfect für alle Geräte und Auflösungen.',          color: '#34d399' },
  { emoji: '💰', title: 'Monetarisierung',    desc: 'Faire Strategien, die Spieler nicht vergraulen. Ethische GamePass- & DevProduct-Integration.',               color: '#f59e0b' },
  { emoji: '💬', title: 'Community Setup',    desc: 'Discord-Server, Social Media & Community-Management für nachhaltiges Spielerwachstum.',                      color: '#5865F2' },
]
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {services.map((s, i) => (
            <div key={s.title} className="reveal rb-panel p-5 group"
              ...
              {/* Icon */}
              <div className="w-14 h-14 rounded-xl flex items-center justify-center text-3xl mb-4 transition-all duration-300 group-hover:scale-110"
                style={{
